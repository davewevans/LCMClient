#pragma checksum "C:\Users\davew\OneDrive\Documents\GitHub\LCMClient\LCMClient\Features\Shared\OrphanCard.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "dfe0dde74eae6139851c263046e02bd3de3874eb"
// <auto-generated/>
...
#nullable disable
    public partial class OrphanCard : Microsoft.AspNetCore.Components.ComponentBase
    {
        ...
        {
            __builder.AddMarkupContent(0, @"<div class=""p-2""><div class=""bg-white px-6 py-8 rounded-lg shadow-lg text-center""><div class=""mb-3""><img class=""w-auto mx-auto rounded-full"" src=""https://i.pravatar.cc/150?img=31"" alt></div>
        <h2 class=""text-xl font-medium text-gray-700"">Pande Muliada</h2>
        <span class=""text-blue-500 block mb-5"">Front End Developer</span>
        <a href=""#"" class=""px-4 py-2 bg-blue-500 text-white rounded-full"">Hire</a></div></div>");
        }
